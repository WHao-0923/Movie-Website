...
function handleResult(resultData) {
    ...
    starInfoElement.append("<p>Star Name: " + resultData["starInfo"]["star_name"] + "</p>" +
        "<p>Date Of Birth: " + resultData["starInfo"]["star_dob"] + "</p>");
    ...
    for (let i = 0; i < Math.min(10, resultData["movies"].length); i++) {
        let rowHTML = "";
        rowHTML += "<tr onclick=\"window.location.href='single-movie.html?movie_id=" + resultData["movies"][i]["movie_id"] + "'\">";
        rowHTML += "<th>" + resultData["movies"][i]["movie_title"] + "</th>";
...
// Get id from URL
let starId = getParameterByName('star_id');
