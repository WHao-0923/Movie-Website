...
public class UpdateSecurePassword {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String insert = "INSERT into employees (email,fullname,password) VALUES('classta@email.edu','TA CS122B',?)";
        PreparedStatement s = connection.prepareStatement(insert);
        s.setString(1,passwordEncryptor.encryptPassword("classta"));
        s.execute();
        System.out.println("employee info inserted");
